...
const (
	docsUrl   = "http://gitlab.dev.iss.digital/mgp/elasticsearch-exporter"
	templates = `
    {{ define "page" -}}
      <html>
      <head>
        <title>Prometheus ElasticSearch Exporter</title>
        <style type="text/css">
      ...
      <body>
        <div class="navbar">
          <div class="navbar-header"><a href="/">Prometheus ElasticSearch Exporter</a></div>
    ...
    {{ define "content.home" -}}
      <p>This is a <a href="{{ .DocsUrl }}">Prometheus ElasticSearch Exporter</a> instance.
...
func ConfigHandlerFunc(metricsPath string, exporter elastic_exporter.Exporter) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
