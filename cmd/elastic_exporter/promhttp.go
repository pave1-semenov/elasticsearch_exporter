...
func ExporterHandlerFor(exporter elastic_exporter.Exporter) http.Handler {
...
func contextFor(req *http.Request, exporter elastic_exporter.Exporter) (context.Context, context.CancelFunc) {
